            ...
            <div className='flex flex-col gap-8 max-w-[620px]'>
                ...
                <Fade direction='up'>
                    <div className='flex gap-3 flex-col sm:flex-row'>
                        <button onClick={() => router.push("#packages")} className='cursor-pointer h-10 w-20 md:w-32 text-sm md:text-md bg-[#d63384] hover:bg-[#d63384b6] text-white'>
                            Apply
                        </button>
                        <button onClick={() => router.push("#packages")} className='cursor-pointer h-10 w-28 md:w-36 text-sm md:text-md bg-[#003A66] hover:bg-[#003a66a0] text-white'>
                            View packages
                        </button>
                    </div>
                </Fade>
